...
# @Date:   2018-07-10T14:00:48-07:00
# @Email:  agupta@juniper.net
# @Filename: linklocal.py
# @Last modified by:   agupta
# @Last modified time: 2018-07-25T13:36:53-07:00
# Add comments and fix error reading TODO
...
def find_uuid(module):
    ...
    response = requests.get(URL+"global-vrouter-configs",headers=headers)
